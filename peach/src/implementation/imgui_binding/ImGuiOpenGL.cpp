...
//  callback to reset render state. 2019-03-29: OpenGL: Not calling glBindBuffer more than necessary in the render loop. 2019-03-15: OpenGL: Added a dummy GL
//  call + comments in ImGui_ImplOpenGL3_Init() to detect uninitialized GL function loaders early. 2019-03-03: OpenGL: Fix support for ES 2.0 (WebGL 1.0).
